  ...
  return (
    <Layout keywords={'about'} title={'Про нас'}>
      ...
      <div className={`${styles.container} ${lato.className}`}>
        <h1 className={styles.title}>Вироби гвинтові палі, ціна від виробника.</h1>
        ...
        <p className={`${styles.paragraph} ${styles.important}`}>Виконуємо роботи будь-якої складності, діаметр паль, глибина вкрутки паль та буріння ям, Ви можете погодити з нашим технічним відділом. Дзвоніть, будемо раді співробітництву.</p>
      </div>
    </Layout>
   )
}
